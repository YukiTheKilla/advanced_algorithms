...
def closest_neighbor(graph, start_vertex):
    ...
    Args:
        ...
        start_vertex (str): The starting vertex for the algorithm.

    Returns:
        time_spent (float): The time spent executing the algorithm.
        iterations (int): The number of iterations performed by the algorithm.
        total_weight (int): The total weight of the edges traversed.
    """

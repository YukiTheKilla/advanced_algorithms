...
class GraphVisualization(tk.Frame):
    def __init__(self, parent):
        ...
        self.iterations_label = Label(self, text="Iterations:")
        ...
        self.evaporation_rate_label = Label(self, text="Evaporation Rate:")
        self.evaporation_rate_label.pack()
        self.evaporation_rate_entry = Entry(self)
        self.evaporation_rate_entry.insert(tk.END, "0.5")
        self.evaporation_rate_entry.pack()
    
        self.alpha_label = Label(self, text="Alpha (a):")
        self.alpha_label.pack()
        self.alpha_entry = Entry(self)
        self.alpha_entry.insert(tk.END, "1")
        self.alpha_entry.pack()
        
        self.beta_label = Label(self, text="Beta (b):")
        self.beta_label.pack()
        self.beta_entry = Entry(self)
        self.beta_entry.insert(tk.END, "1")
    ...
    def algorithm_func(self):
        ...
        evaporation_rate = float(self.evaporation_rate_entry.get())

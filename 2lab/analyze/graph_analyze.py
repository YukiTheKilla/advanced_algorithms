...
def create_gui():
    ...
    def execute_functions(file_paths):
        ...
        total_weights_list = [[] for _ in range(5)]
        ...
        for file_path in file_paths:
            ...
            for i, func in enumerate([original_func_wrapper, heap_store_func_wrapper, vertex_choose_func_wrapper,original_simulated_annealing_wrapper, multiple_annealing_wrapper]):
    ...
    def plot_graph(x_data, y_data, ylabel, title):
        plt.figure()
        function_names = ["Closest Neighbour(CN)", "Heap Vertex(CN)", "Best Vertex(CN)","Simulated Annealing(SA)","Muliple Anneling(SA)"]
